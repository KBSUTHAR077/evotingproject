...
<script type="text/javascript">
	...
	cities['India']['Maharashtra'] = new Array('Mumbai', 'Pune', 'Nagpur',
			'Nashik');
	cities['India']['Uttar Pradesh'] = new Array('Kanpur', 'Gaziabad',
			'Lucknow', 'Agra', 'Varanasi', 'Allahabad');
	...
	var Party = new Array();
	Party['BJP'] = new Array('CANDIDATE1', 'CANDIDATE2', 'CANDIDATE3',
	...
	Candidate['BJP']['CANDIDATE1'] = new Array('ID1', 'ID2', 'ID3', 'ID4',
			'ID5', 'ID6');
	Candidate['BJP']['CANDIDATE2'] = new Array('ID1', 'ID2', 'ID3', 'ID4',
			'ID5', 'ID6');
...
<body id="top">
	...
	<div class="bgded overlay"
		style="background-image: url('images/demo/backgrounds/11.png');">
		<!-- ################################################################################################ -->
	...
	<div class="wrapper row3">
		...
		<ul class="nospace group">
			<li class="one_quarter first"><article> <a href="#"><i
					class="icon btmspace-30 fa fa-gitlab"></i></a>
				<h6 class="heading font-x1">BSP</h6>
				<p>BAHUJAN SAMAJ PARTY [&hellip;]</p>
				</article></li>
			<li class="one_quarter"><article> <a href="#"><i
					class="icon btmspace-30 fa fa-globe"></i></a>
				<h6 class="heading font-x1">BJP</h6>
				<p>BHARTIYA JANTA PARTY[&hellip;]</p>
				</article></li>
			<li class="one_quarter"><article> <a href="#"><i
					class="icon btmspace-30 fa fa-tencent-weibo"></i></a>
				<h6 class="heading font-x1">CPI</h6>
				<p>COMMUNIST PARTY OF INDIA[&hellip;]</p>
				</article></li>
			<li class="one_quarter"><article> <a href="#"><i
					class="icon btmspace-30 fa fa-wpexplorer"></i></a>
	...
	<div class="wrapper row4 bgded overlay"
		style="background-image: url('images/demo/backgrounds/13.jpg');">
		...
		<div class="center btmspace-50">
			...
			<ul class="nospace inline pushright uppercase">
				...
				<li><a href="VoterUpdate?vid=${VfName.getVid()}">Profile
						View/Update</a></li>
				<li><a href="VoterViewForm?vid=${VfName.getVid()}">Profile
						View</a></li>
				<li><a href="VoterViewForm?vid=${VfName.getVid()}">Cancel
			...
			<div class="two_third">
				<div class="background">
					<div class="transbox">
						...
						<p class="nospace btmspace-15">This Registration Form is
							registered by candidate under the supervision of Election
							Commissioner</p>

						<fieldset>
							<legend>Login:</legend>

<%--<%=request.getParameter("cepicno") %>--%>
							<form action="VotingLog" method="get">
                        castEpicNo= ${castEpicNo} <%-- <%= request.getParameter("castEpicNo") %> --%>
								 <input type="hidden" name="castEpicNo" 
								...
								<table border="2" color="red" cellpadding="5">
										...
										<td colspan="2" align="left" width="30%">
											<p class="nospace btmspace-15">
												-----Cast Voting------ <img
													...
													src="images/demo/backgrounds/13.jpg"
													style="width: 32%; height: 25%; margin-left: 0%"
													align="right">
											</p>
										</td>
									</tr>
									<tr>
										<td style="text-align: left;"><p
												class="nospace btmspace-15">Country:</p></td>
										<td style="text-align: left;"><select
											name="castVotingCountry" id="canNomiAreaCountry"
											onchange="setStates();">
									...
									<tr>
										<td style="text-align: left;"><p
												class="nospace btmspace-15">State:</P></td>
										<td style="text-align: left;"><select
											name="canNomiAreaState" id="canNomiAreaState"
											onchange="setCities();">
												<option value=""><p class="nospace btmspace-15">Please
														select a Country</P>
												</option>
										</select></td>
									</tr>
									<tr>
										<td style="text-align: left;"><p
												class="nospace btmspace-15">City:</p></td>
										<td style="text-align: left;"><select
											name="canNomiAreaCity" id="canNomiAreaCity">
												<option value=""><p class="nospace btmspace-15">Please
														select a Country</p>
												</option>
										</select></td>
									...
									<tr>
										<td style="text-align: left;"><p
												class="nospace btmspace-15">PARTY:</p></td>
										<td style="text-align: left;"><select name="partyName"
											id="partyc" onchange="setPARTYp();">
									...
									<tr>
										<td style="text-align: left;"><p
												class="nospace btmspace-15">CANDIDATE:</p></td>
										<td style="text-align: left;"><select name="castCanName"
											id="canp" onchange="setCANDIDATEp();">
												<option value="">Please select a State</option>
										</select></td>
									</tr>
									<tr>
										<td style="text-align: left;"><p
												class="nospace btmspace-15">CANDIDATEID:</p></td>
										<td style="text-align: left;"><select name="canpid"
											id="canpid">
												<option value="">Please select a State</option>
										</select></td>
									</tr>
									...
									<!-- <input type="hidden" name="castId"
									 value="${VfName.castvote.getCastVid().getCastEpicNo()}">
  ...
  <option value="">Please select a Country</option>
	...
	<div class="wrapper row5">
		<div id="copyright" class="hoc clear">
			<!-- ################################################################################################ -->
			<p class="fl_left">
				Copyright &copy; 2017 - All Rights Reserved - <a href="#">I-voting</a>
			</p>
			<p class="fl_right">
