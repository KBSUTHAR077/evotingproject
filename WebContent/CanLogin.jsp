        ...
        <form method="post" action="CandidateLogin">
          <fieldset>
            <legend>Login:</legend>
             ...
             <input class="btmspace-15" type="email" value="" name="canEmailId" placeholder="Email">
            <input class="btmspace-15" type="password" value=""  name="canPassword" placeholder="Name">
           <input type="radio" name="canStatus1" value=" Registered" checked=" Registered" size="10">
