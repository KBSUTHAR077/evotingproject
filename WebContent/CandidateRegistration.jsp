...
<tr>
<td>Gender</td>
<td><input type="radio" name="cangender" value="male" size="10">Male
...
<select name="cancorrescountry" id="cancorrescountry" onchange="setStates();">
  <option value="India">India</option>
  <option value="Other">other</option>
...
<td style="text-align: left;">
<select name="cancorresstate" id="cancorresstate" onchange="setCities();">
...
<td style="text-align: left;">
<select name="cancorrescity"  id="cancorrescity">
  <option value="">Please select a Country</option>
</select>
</td>
</tr>
...
<td style="text-align: left;">Country:</td>
<td style="text-align: left;">
<select name="canpermacountry" id="canpermacountry" onchange="setStatesp();">
  <option value="India">India</option>
  <option value="Other">other</option>
...
<td style="text-align: left;">State:</td>
<td style="text-align: left;">
<select name="canpermastate" id="canpermastate" onchange="setCitiesp();">
  <option value="">Please select a Country</option>
</select>
</td>
</tr><tr>
...
<td style="text-align: left;">State:</td>
<td style="text-align: left;">
<select name="canNomiAreaState" id="canNomiAreaState" onchange="setCitiesnominee();">
  <option value="">Please select a Country</option>
</select>
</td>
</tr><tr>
