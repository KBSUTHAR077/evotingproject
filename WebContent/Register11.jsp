  ...
  <section class="hoc container clear"> 
    ...
    <ul class="nospace group">
      <li class="one_quarter first">
        <article><a href="Bsp.jsp"><i class="icon btmspace-30 fa fa-gitlab"></i></a>
          <h6 class="heading font-x1">BSP</h6>
          <p>BAHUJAN SAMAJ PARTY [&hellip;]</p>
        </article>
      </li>
      <li class="one_quarter">
        <article><a href="Bjp.jsp"><i class="icon btmspace-30 fa fa-globe"></i></a>
          <h6 class="heading font-x1">BJP</h6>
          <p>BHARTIYA JANTA PARTY[&hellip;]</p>
        </article>
      </li>
      <li class="one_quarter">
        <article><a href="Cpm.jsp"><i class="icon btmspace-30 fa fa-tencent-weibo"></i></a>
          <h6 class="heading font-x1">CPI</h6>
          <p>COMMUNIST PARTY OF INDIA[&hellip;]</p>
        </article>
      </li>
      <li class="one_quarter">
        <article><a href="Inc.jsp"><i class="icon btmspace-30 fa fa-wpexplorer"></i></a>
...
<div class="two_third">
 <div class="background">
      <div class="transbox">
        <h6  id="Register11">GENERAL VOTERS REGISTRATION  FORM</h6>
...
<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">RelationShip Status</p></td>
...
<tr>
<td><p class="nospace btmspace-15">Gaurdian's Name</p></td>
<td><input  type="text" name="vgaurdianname" ></td>
</tr>

<tr>
<td></span><p class="nospace btmspace-15">Age</p></td>
...
<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Adhar No</p></td>
<td><input  type="text" name="vadharno"  ></td>
</tr>
<!-- 
<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Adhar Doc</p></td>
<td><input   maxlength="12" type="file" name="vadhardoc"  ></td>
</tr>
 -->
<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Pan No</p></td>
<td><input  type="text" name="vpanno"  ></td>
</tr>
<!--  
<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Pan Doc</p></td>
<td><input  type="file" name="vpandoc"  ></td>
</tr>
  -->
<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Photo</p></td>
<td><input  type="file" name="vphoto"  ></td>
</tr>

<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Mobile No</p></td>
<td><input  type="text" name="vmob"  ></td>
</tr>


<tr>
<td colspan="2"><p class="nospace btmspace-15">-----Correspondance address------</p></td></tr>
<tr>
<td style="text-align: left;"><p class="nospace btmspace-15">Country:</p></td>
<td style="text-align: left;">
<select name="vcorrescountry" id="vcorrescountry" >
...
<td style="text-align: left;">
<select name="vcorresstate" id="vcorresstate" onchange="setStatesc();">
...
<td style="text-align: left;">
<select name="vcorrescity"  id="vcorrescity" onchange="setCitiesc();">
...
<td style="text-align: left;">
<select name="vcorrestown"  id="vcorrestown">
  <option value="">Please select a State</option>
</select>
</td>
</tr>
...
<td><input  type="text" name="vcorresaddress" size="50" ></td>
</tr>
<tr>
<tr>
<td><p class="nospace btmspace-15">Pincode</p></td>
<td><input  type="text" name="vcorrespincode" size="50" ></td>
</tr>
<tr>
...
<td style="text-align: left;"><p class="nospace btmspace-15">Country:</p></td>
<td style="text-align: left;">
<select name="vpermacountry"  id="vpermacountry" >
  <option value="India">India</option>
  <option value="Other">other</option>
...
<td style="text-align: left;">
<select name="vpermastate" id="vpermastate" onchange="setStatesp();">
 <option value="Maharashtra">Maharashtra</option>
  <option value="Uttar Pradesh">Uttar Pradesh</option>
...
<td style="text-align: left;">
<select name="vpermacity"  id="vpermacity" onchange="setCitiesp();">
  <option value="">Please select a State</option>
</select>
</td>
</tr><tr>
...
<td style="text-align: left;">
<select name="vpermatown"  id="vpermatown">
  <option value="">Please select a State</option>
</select>
</td>
</tr>
...
<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Voter Address</p></td>
<td><input  type="text" name="vpermaaddress"  ></td>
</tr>
<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Pincode</p></td>
<td><input  type="text" name="vpermapincode"  ></td>
</tr>

<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Differently Challenged</p></td>
...
<tr>
<td><p class="nospace btmspace-15">RePassword</p></td>
<td><input  type="text" name="vrepassword"  ></td>
</tr>

<tr>
<td><span class="required">*</span><p class="nospace btmspace-15">Security Question</p></td>
...
<tr><td><span class="required">*</span><p class="nospace btmspace-15">Security Answer</p></td>
