    ...
    <!--    <div class="one_third first">
      ...
      <div class="one_third">
        ...
        <form method="post" action="VotingLog">
          <fieldset>
            <legend>Choose party:</legend>
            
            <table border="0" cellpadding="5">

<tr>
<td><p  class="nospace btmspace-15">PartyName</p></td>
...
<tr>
<td><p  class="nospace btmspace-15">PartySymbol</p></td>
...
<tr><td><p  class="nospace btmspace-15">PartyCanRegId</p></td>
