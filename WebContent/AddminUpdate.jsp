...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <form name="myform1" action="AdminUpdate" method="post">
<table border="0" cellpadding="5" align="left">
 <tr>
<td>ID</td>
<td><input type="text" name="adminId" value="${list.getAdminId()}"></td>
</tr>
      <tr>
<td>First Name</td>
<td><input type="text" name="adminFirstName" value="${list.getAdminFirstName()}"></td>
</tr>
      <td>Middle Name</td>
<td><input type="text" name="adminMiddleName" value="${list.getAdminMiddleName()}"></td>
</tr>
<td>Last Name</td>
<td><input type="text" name="adminLastName" value="${list.getAdminLastName()}"></td>
</tr>
<td>Security Question</td>
<td><select name="adminSecurityQues" value="${list.getAdminSecurityQues()}">
...
<td><input type="text" name="adminSecurityAnswer" value="${list.getAdminSecurityAnswer()}"></td>
</tr>
<tr><td>Scanned Photo of registering admin for Holding Admin Desgination</td>
<td align="right"><input type="file" name="adminPhoto"  value="${list.getAdminPhoto()}"></td>
</tr>
<td>Email Id</td>
<td><input type="text" name="adminEmailId" value="${list.getAdminEmailId()}"></td>
</tr>
<td>Password</td>
<td><input type="text" name="adminPassword" value="${list.getAdminPassword()}"></td>
</tr>
<td>RePassword</td>
<td><input type="text" name="adminRepassword" value="${list.getAdminRepassword()}"></td>
</tr>
<td>Scanned file for Holding Admin Desgination</td>
<td><input type="file" name="adminHscanFile" value="${list.getAdminHscanFile()}"></td>
</tr>
<tr><td></td><td>
