      ...
      <nav class="sdb_holder">
        <ul>
          ...
          <li><a href="AdminCandidateView">Candidate Profile</a></li>
          		 ...
          		 <li><a href="AdminCandidateView">Party View</a></li>
           		<ul>
           			<li><a href="AdminPartyView">Add Party</a></li>
         			<li><a href="#CMlist">View/delete </a></li>
          		</ul>
...
<tr><td><p class="nospace btmspace-15">${i.adminId }</p></td>
 	<td>${i.adminFirstName }</td>
 	<td>${i.adminMiddleName }</td>
 	<td>${i.adminLastName }</td>
 	<td>${i.adminSecurityQues }</td>
 	<td>${i.adminSecurityAnswer }</td>
 	<td><img src="AdminImage?adminPhoto=${i.adminPhoto }"  style="width: 150px;height:150px; ">
							</td>
 	<td>${i.adminEmailId }</td>
 	<td>${i.adminPassword }</td>
 	<td>${i.adminRepassword }</td>
 	<td>${i.adminHscanFile }</td>
 	<td><a href="AdminUpdate?adminId=${i.adminId}">Update</a></td>
 <td><a href="DeleteServlet?adminId=${i.adminId}">Delete</a></td>
