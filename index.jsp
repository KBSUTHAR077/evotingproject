...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');"> 
  ...
  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <h3 class="heading">Imperdiet consequat integer est</h3>
      <p>Tempus leo in dictum lectus urna vitae dolor integer ut nibh ut dapibus etiam in augue phasellus ultricies ligula</p>
      <p class="font-x1 uppercase bold">Libero cursus malesuada etiam</p>
      <footer>
        <ul class="nospace inline pushright">
          <li><a class="btn" href="#">VISITORS</a></li>
          <li><a class="btn inverse" href="#">CANDIDATES</a></li>
        </ul>
      </footer>
    </article>
    <!-- ################################################################################################ -->
